...
setup(
  ...
  packages=['master', 'base', 'dbid', 'utils', 'meta', 'musicdb', 'match' ,'gate']
    + ['lib.genius', 'lib.musicbrainz', 'lib.spotify', 'lib.discogs', 'lib.rateyourmusic', 'lib.allmusic', 'lib.lastfm', 'lib.deezer', 'lib.albumoftheyear', 'lib.metalarchives', 'lib.setlistfm', 'lib.beatport', 'lib.traxsource', 'lib.mymixtapez', 'lib.classicalarchives']
)
